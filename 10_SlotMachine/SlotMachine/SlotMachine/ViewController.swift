...
class ViewController: UIViewController {
    ...
    func resetButtonPressed(button:UIButton) {
        //println("\(button.titleLabel?.text)  pressed")
        hardReset()
    }
    ...
    func spinButtonPressed(button:UIButton) {
        ...
        println("Total Multiplier \(winningsMultiplier)")
    ...
    func setupContainerViews() {
        ...
        self.secondContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView
            , y: firstContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * (3 * kSixth)))
...
//        containerView.addSubview(creditsLabel)
        setupThirdContainerLabel(self.creditsLabel,text: "000000",textColor: UIColor.redColor(),fontType: UIFont(name: "Menlo-Bold", size: 16),center: CGPoint(x: containerView.frame.width * kSixth, y: containerView.frame.height * kThird), textAlignment: NSTextAlignment.Center,backGroundC: UIColor.darkGrayColor(), cv: containerView)
...
//        containerView.addSubview(self.betLabel)
        setupThirdContainerLabel(self.betLabel,text: "0000",textColor: UIColor.redColor(),fontType: UIFont(name: "Menlo-Bold", size: 16),center: CGPoint(x: containerView.frame.width * kSixth * 3, y: containerView.frame.height * kThird), textAlignment: NSTextAlignment.Center,backGroundC: UIColor.darkGrayColor(), cv: containerView)
...
//        containerView.addSubview(winnerPaidLabel)
        setupThirdContainerLabel(self.winnerPaidLabel,text: "000000",textColor: UIColor.redColor(),fontType: UIFont(name: "Menlo-Bold", size: 16),center: CGPoint(x: containerView.frame.width * kSixth * 5, y: containerView.frame.height * kThird), textAlignment: NSTextAlignment.Center,backGroundC: UIColor.darkGrayColor(), cv: containerView)
...
//        self.creditsTitleLabel.textAlignment = NSTextAlignment.Center
    ...
    func setupThirdContainerLabel(label:UILabel, text:String, textColor:UIColor, fontType:UIFont!, center:CGPoint, textAlignment:NSTextAlignment, backGroundC:UIColor,cv:UIView) {
        label.text = text
        ...
        label.backgroundColor = backGroundC
        cv.addSubview(label)
